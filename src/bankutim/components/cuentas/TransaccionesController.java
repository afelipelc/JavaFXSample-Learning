...
public class TransaccionesController extends BorderPane implements Initializable {
    ...
    public TransaccionesController(double width, double height){
        ...
        noCuentaCol.setCellValueFactory(new PropertyValueFactory<Transaccion, Integer>("noCuenta"));
        cargoCol.setCellValueFactory(new PropertyValueFactory<Transaccion, Float>("cargo"));
        abonoCol.setCellValueFactory(new PropertyValueFactory<Transaccion, Float>("abono"));
